...
";
        // line 43
        if (((twig_length_filter($this->env, twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "demarcheur", [], "any", false, false, false, 43), "publications", [], "any", false, false, false, 43)) >= 1) && (twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "name", [], "any", false, false, false, 43)) || twig_test_empty(twig_get_attribute($this->env, $this->source, ($context["user"] ?? null), "surname", [], "any", false, false, false, 43))))) {
            // line 44
            echo "    <div class=\"container\">
        <div class=\"row\">
            <h4 class=\"col-md-12 alert alert-warning\" style=\"text-align: center;margin-bottom: 10px;\">Renseigner votre nom et prénoms pour que vos publications soient visible sur le site Chapmaison.com</h4>
            <div class=\"col-md-12\" style=\"text-align: center;margin-bottom: 10px;\">
                <a href=\"";
            // line 48
            echo url("demarcheur/account");
            echo "\" class=\"btn btn-primary\">Je termine mon inscription</a>
            </div>
        </div>
    </div>
";
    ...
    {
        return array (  132 => 48,  126 => 44,  124 => 43,  112 => 38,  103 => 36,  99 => 35,  93 => 34,  89 => 33,  83 => 32,  75 => 31,  50 => 9,  41 => 2,  37 => 1,);
    }
...
{% if user.demarcheur.publications|length >= 1 and (user.name is empty or user.surname is empty) %}
    <div class=\"container\">
        <div class=\"row\">
            <h4 class=\"col-md-12 alert alert-warning\" style=\"text-align: center;margin-bottom: 10px;\">Renseigner votre nom et prénoms pour que vos publications soient visible sur le site Chapmaison.com</h4>
            <div class=\"col-md-12\" style=\"text-align: center;margin-bottom: 10px;\">
                <a href=\"{{ url('demarcheur/account') }}\" class=\"btn btn-primary\">Je termine mon inscription</a>
            </div>
        </div>
    </div>
{% endif %}", "/Applications/MAMP/htdocs/recherchemaison/themes/demo/partials/site/header_demarcheur.htm", "");
    }
}
