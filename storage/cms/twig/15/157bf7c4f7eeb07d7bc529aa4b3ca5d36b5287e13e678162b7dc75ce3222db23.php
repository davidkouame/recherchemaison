...
<div class=\"container\" >
    <form class=\"row\" role=\"form\" data-request=\"onCreateUserTwoStep\" data-request-files>
        ...
        echo "                    </select>
                ...
                <div class=\"form-group col-md-6\">
                    <label for=\"\">Ajouter votre agrémént <span class=\"required\">*</span></label>
                    <input type=\"file\" name=\"agrement\" class=\"form-control\">
                </div>
                <div class=\"form-group col-md-6\">
        ...
        <!-- Démarcheur -->
        <div class=\"col-md-offset-3 col-md-8\" id=\"demarcheur_first_login\">
            <h3 style=\"padding-left: 14%;\">Information du démarcheur</h3>
            <div class=\"row\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["localisation"]) {
            // line 72
            echo "                            <option value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["localisation"], "id", [], "any", false, false, false, 72), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["localisation"], "libelle", [], "any", false, false, false, 72), "html", null, true);
            echo "</option>
                        ";
        }
        $_parent = $context['_parent'];
        ...
        echo "                    </select>
            ...
            <button type=\"submit\" class=\"btn btn-primary active\" style=\"margin-left: 24%\">Terminez l'inscription</button>
        </div>
    </form>
</div>
";
    ...
    {
        return array (  138 => 74,  127 => 72,  123 => 71,  95 => 45,  84 => 43,  80 => 42,  37 => 1,);
    }
