...
class __TwigTemplate_8593a7daba71251c4786ac1a60a218f7308df83c5df575b16b79b51030b6e696 extends \Twig\Template
{
    ...
    <form class=\"row\" role=\"form\" data-request=\"onCreateUserTwoStep\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["localisation"]) {
            // line 38
            echo "                            <option value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["localisation"], "id", [], "any", false, false, false, 38), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["localisation"], "libelle", [], "any", false, false, false, 38), "html", null, true);
            echo "</option>
                        ";
        }
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["localisation"]) {
            // line 63
            echo "                            <option value=\"";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["localisation"], "id", [], "any", false, false, false, 63), "html", null, true);
            echo "\">";
            echo twig_escape_filter($this->env, twig_get_attribute($this->env, $this->source, $context["localisation"], "libelle", [], "any", false, false, false, 63), "html", null, true);
            echo "</option>
                        ";
        }
        $_parent = $context['_parent'];
...
";
    ...
    {
        return array (  129 => 65,  118 => 63,  114 => 62,  90 => 40,  79 => 38,  75 => 37,  37 => 1,);
    }
