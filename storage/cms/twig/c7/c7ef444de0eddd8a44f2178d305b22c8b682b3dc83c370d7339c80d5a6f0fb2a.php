...
<div class=\"collapse navbar-collapse navbar-main-collapse\" id=\"collapse-navbar\">
    <ul class=\"nav navbar-nav\">
        <li class=\"";
        // line 32
        if ((twig_get_attribute($this->env, $this->source, twig_get_attribute($this->env, $this->source, ($context["this"] ?? null), "page", [], "any", false, false, false, 32), "id", [], "any", false, false, false, 32) == "agence")) {
            echo "active";
        }
        echo "\"><a href=\"";
        echo url("/");
    ...
    {
        return array (  108 => 36,  100 => 35,  92 => 34,  84 => 33,  76 => 32,  50 => 9,  41 => 2,  37 => 1,);
    }
